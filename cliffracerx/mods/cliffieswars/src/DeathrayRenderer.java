...
public class DeathrayRenderer implements IItemRenderer {
	ModelDeathray model;

	public DeathrayRenderer() {
		model = new ModelDeathray();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
	    ...
	    float temp = 1.55f;
	    HandheldDeathray deathray = (HandheldDeathray)tempItm;
		switch (type) {
