...
public class LaserEntity extends Entity implements IProjectile
{
    ...
    public LaserEntity(World par1World)
    {
        super(par1World);
    ...
    public LaserEntity(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public LaserEntity(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public LaserEntity(World par1World, EntityLivingBase par2EntityLivingBase, float par3, String col)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)i1))
                    {
                        ...
                        this.playSound("cliffieswarsmod:laser", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
