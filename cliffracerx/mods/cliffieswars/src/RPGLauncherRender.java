...
public class RPGLauncherRender implements IItemRenderer {
    ModelRPGLauncher model;

    public RPGLauncherRender() {
        model = new ModelRPGLauncher();
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        float temp = 1.55f;
        HandheldRocketLauncher rpglauncher = (HandheldRocketLauncher)tempItm;
        switch (type) {
        ...
        case EQUIPPED: // render in third person
            ...
            GL11.glTranslatef(-0.8F, 1.4F-temp, -0.1F); //translate model to fit in the hand of the player
            model.render((Entity) data[1], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
                    0.0625F, mc, rpglauncher);
...
//first person render
        ...
        case INVENTORY: //render in the inventory
            ...
            model.render((Entity) mc.thePlayer, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
                    0.0625F, mc, rpglauncher);
            GL11.glPopMatrix();
            break;
