...
public class RenderRPG extends Render
{
    ...
    {
        return this.getArrowTextures((RPGEntity)par1Entity);
    }
     ...
     * (Render<T extends Entity) and this method has signature public void doRender(T entities, double d, double d1,
     * double d2, float f, float f1). But JAD is pre 1.5 so doesn't do that.
     */
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderArrow((RPGEntity)par1Entity, par2, par4, par6, par8, par9);
    }
}
